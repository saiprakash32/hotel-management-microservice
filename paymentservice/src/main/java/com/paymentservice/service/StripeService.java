        ...
        public StripeResponse checkoutProducts(ProductRequest productRequest) {
            ...
            SessionCreateParams.LineItem.PriceData.ProductData productData =
                    SessionCreateParams.LineItem.PriceData.ProductData.builder()
                            .setName(productRequest.getPropertyName())
                            .build();
            ...
            SessionCreateParams.LineItem.PriceData priceData =
                    SessionCreateParams.LineItem.PriceData.builder()
                            ...
                            .setUnitAmount(productRequest.getBasePrice())
            ...
            SessionCreateParams.LineItem lineItem =
                    SessionCreateParams
                            .LineItem.builder()
                            .setQuantity(productRequest.getTotalNigths())
...
//            System.out.println(p);
            SessionCreateParams params =
                    SessionCreateParams.builder()
                            ...
                            .setSuccessUrl("http://localhost:8086/product/v1/success?session_id={CHECKOUT_SESSION_ID}&booking_id="+bookingId)
